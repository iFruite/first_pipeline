 ...
 */
package com.bytheone.actlistener;
...
public class ListenUserRole {
     ...
     * @param joinPoint
     */
    @Around("execution(com.bytheone.util.JsonUtil com.bytheone.controller.UserController.updateUser(*,String[]))")
     ...
     * @param joinPoint
     */
    @Around("execution(com.bytheone.util.JsonUtil com.bytheone.controller.UserController.addUser(*,String[]))")
    ...
    @Around("execution(com.bytheone.util.JsonUtil com.bytheone.controller.UserController.del(..))")
    ...
    /**********************角色处理begin***************************/
    @Around("execution(com.bytheone.util.JsonUtil com.bytheone.controller.RoleController.addRole(*,String[]))")
    ...
    @Around("execution(com.bytheone.util.JsonUtil com.bytheone.controller.RoleController.updateUser(*,String[]))")
    ...
    @Around("execution(com.bytheone.util.JsonUtil com.bytheone.controller.RoleController.del(..))")
