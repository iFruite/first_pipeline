...
<div class="layui-layout layui-layout-admin kit-layout-admin">
  <div class="layui-header">
    <div class="layui-logo"><a class="layui-logo" href="javascript:t();">C D M 线索管理</a></div>
    <div class="layui-logo kit-logo-mobile"></div>
    <div class="layui-hide-xs">
    <ul class="layui-nav layui-layout-left kit-nav">
      <li class="layui-nav-item"><a href="javascript:s();">用户管理</a></li>
    ...
    <ul class="layui-nav layui-layout-right kit-nav">
      ...
      <li class="layui-nav-item">
        ...
        <#assign currentUser = Session["curentUser"]>
          <img src="/images/${currentUser.photo}" class="layui-nav-img">${currentUser.real_name}
        </a>
        <dl class="layui-nav-child">
      ...
      <li class="layui-nav-item"><a href="/logout"><i class="fa fa-sign-out" aria-hidden="true"></i> 退出</a></li>
    </ul>
  </div>
...
<@tree data=menu start="start" end="end"/>
  ...
  <!-- 底部固定区域 -->
  2017 &copy;
  <a target="_blank" href="https://artlinty.com">ArtLinty</a> 由 &copy; ByTheOne 倾心打造的一款 C D M 线索管理系统 <#--技术交流请联系本人-liu.tingli@qq.com-->
</div>
</div>
