    ...
    <div style="margin-left:25%">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="width:190px;">
                <select name="clueType" id="clueType" lay-verify="clueType"  lay-filter="clueType">
                    <option value=""></option>
                    <option value="2">一级线索</option>
                    <option value="0">二级线索</option>
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
          <div style="margin-left: 20px;margin-top:5px">
            <ul>
              <li style="display: inline-block;width: 50px;" id="clue-icon"><i class="layui-icon" id="icon"  style="font-size: 25px;"></i></li>
