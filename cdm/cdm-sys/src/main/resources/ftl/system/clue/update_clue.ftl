...
<div class="x-body">
  <form class="layui-form layui-form-pane" style="margin-left: 20px;">
    ...
    <div style="margin-left:25%">
        <div class="layui-form-item">
            <label for="clueType" class="layui-form-label">
                <span class="x-red">*</span>类型
            </label>
          <div class="layui-input-block" style="width:190px;">
                <select  disabled id="clueType" lay-verify="clueType"  lay-filter="clueType">
                    <option value=""></option>
                    <option <#if (sysClue.PId)??==null>selected</#if> value="2">一级线索</option>
                    <option <#if sysClue.clueType='0'&&(sysClue.PId)??>selected</#if> value="0">二级线索</option>
                    <option <#if sysClue.clueType=='1'>selected</#if> value="1">按钮</option>
                </select>
            </div>
        </div>
        <div class="layui-form-item" id="pDiv">
            ...
            <div class="layui-input-inline">
               <#-- <input type="hidden"  id="pId" value="${sysClue.PId}">-->
                 <#--保留 但不做更新-->
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text"  value="${sysClue.name}" id="name" name="name"  lay-verify="name"
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text"  value="${sysClue.url}" id="url" name="url" lay-verify="url"  autocomplete="off" class="layui-input">
      </div>
    </div>
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text"  value="${sysClue.permission}" id="permission" name="permission"  lay-verify="permission"
               autocomplete="off" class="layui-input">
      </div>
    </div>
    <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <div style="margin-left: 20px;margin-top:5px">
                    <ul>
                      <li style="display: inline-block;width: 50px;" id="clue-icon"><i class="layui-icon" id="icon"  style="font-size: 25px;">${sysClue.icon}</i></li>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
          <input type="text" id="orderNum" value="${sysClue.orderNum}" name="orderNum"  lay-verify="orderNum"
                 autocomplete="off" class="layui-input">
        </div>
    </div>
...
<script>
  ...
  form.on('select(clueType)', function(data){
      if(data.value=='2'){
          $('#pId').val('');
